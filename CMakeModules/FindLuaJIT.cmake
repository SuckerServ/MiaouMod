...
IF (LUA_USE_LUAJIT)
    ...
    SET (LUA_INCLUDE_DIRS ${CMAKE_FIND_ROOT_PATH}/include/luajit-2.0 /usr/include/luajit-2.0 /usr/local/include/luajit-2.0)
ELSE (LUA_USE_LUAJIT)
...
FIND_LIBRARY (LUA_LIBRARY NAMES ${LUA_LIBRARY_NAME} PATHS ${CMAKE_FIND_ROOT_PATH}/lib /usr/lib /usr/local/lib)
...
IF (Lua_FOUND)
    IF (NOT Lua_FIND_QUIETLY)
        MESSAGE(STATUS "Found ${LUA_INTERPRETER_TYPE} library: ${LUA_LIBRARY}; ${LUA_INCLUDE_DIR}")
